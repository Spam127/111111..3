...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`---------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(`@help | Omaaàr RG I Back 2019 Bot`,"http://twitch.tv/y04zgamer")
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`---------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(`@play| Aventure Serevr `,"http://twitch.tv/y04zgamer")
   client.user.setStatus("dnd")
});



client.login("NTIyNzQwMzk2NzAzNjEyOTI4.Dyjf0w.iZsjoEQr1e7tKx2vPKq2uH_v8UI");